...
import { useCancelamento } from '../../hooks/useCancelamento';


const CancelamentoObs = () => {
        ...
        <div className="container-data">
            ...
            <form className='form-cancelamento'>
                <div className="form-group">
                    <label className='label-mensagem'>Contato do cliente:</label>
                    <textarea
                ...
                <div className="form-group">
                    <label className='label-mensagem'>Nome do cliente:</label>
                    <textarea
                        value={nomeCliente}
                ...
                <div className="form-group">
                    <label className='label-mensagem'>Por onde?</label>
                    <textarea
                        value={porOnde}
                        onChange={(e) => setPorOnde(e.target.value)}
                        placeholder="Descreva por onde o cliente solicitou"
                        className="textarea"
                    />
                </div>
                <div className="form-group">
                    <label className='label-mensagem'>Motivo da solicitação:</label>
                    <textarea
                ...
                <div className="form-group">
                    <label className='label-mensagem'>Link do chat:</label>
                    <textarea
                        value={linkChat}
                        onChange={(e) => setLinkChat(e.target.value)}
                        placeholder="Insira o link do chat:"
                        className="textarea"
                    />
                </div>
            </form>
            ...
            <ToastContainer position="bottom-end" className="p-3">
                ...
                <Toast 
                    onClose={() => setShowToastCopiar(false)} 
                    show={showToastCopiar} 
                    delay={3000} 
                    autohide 
                    bg="success"
                >
                    ...
                    <Toast.Body className="text-white">Observação copiada com sucesso!</Toast.Body>
                </Toast>
...
export default CancelamentoObs;
