...
const LoginPage = () => {
  ...
  const { handleLogin, username, setUsername, password, setPassword, code, setCode, error } = useLogin();
    ...
    <body>
      <div>
        ...
        <form onSubmit={handleLogin}>
          ...
          />
          <button type="submit" className='inicio'>Login</button>
        </form>
        {error && <p className='error'>{error}</p>}
        </section>
        <button class="btn-github" onClick={() => window.location.href='https://github.com/caiohobold/Painel-Suporte-NextFit'}>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
